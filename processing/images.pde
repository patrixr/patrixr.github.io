/* @pjs preload="assets/images/image1.png"; */
/* @pjs preload="assets/images/image2.png"; */
/* @pjs preload="assets/images/image3.png"; */
/* @pjs preload="assets/images/image4.png"; */
/* @pjs preload="assets/images/image5.png"; */
/* @pjs preload="assets/images/image6.png"; */
...
void pickImage()
{
  img = loadImage("assets/images/" + ImageList[imageIndex++ % ImageList.length]);
  img.resize(width, 0);
}
